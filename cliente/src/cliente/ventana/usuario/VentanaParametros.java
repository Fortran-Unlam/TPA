...
public class VentanaParametros extends JPanel {
	...
	private static final long serialVersionUID = 2065889922586551284L;
			...
			public void run() {
				...
				frame.addWindowListener(new WindowAdapter() {
					...
					public void windowClosing(WindowEvent e) {
						...
						if (!puerto2.getText().isEmpty()) {
							Param.PORT_2 = Integer.parseInt(puerto1.getText());
						}
						if (!puerto3.getText().isEmpty()) {
							Param.PORT_3 = Integer.parseInt(puerto1.getText());
						}
						if (!puerto4.getText().isEmpty()) {
							Param.PORT_4 = Integer.parseInt(puerto1.getText());
						}
	...
	/**
	 * When adding a tab to the accordion, you must supply text for the tab as well
	 * as a component that will be used as the content contained for tab. The
	 * example below will add five tabs The first tab will contain the text "Tab 1"
	 * and a JButton The second tab will contain the text "Tab 2" and a JLabel The
	 * third tab will contain the text "Tab 3" and a JTree wrapped in a JScrollpane
	 * The fourth tab will contain the text "Tab 4" and an empty JPanel, with opaque
	 * = true The fifth tab will contain the text "Tab 5" and an empty JPanel with
	 * opaque = false
	 * 
	...
	/**
	 * You can change the look and feel of the component by changing its ui. In this
	 * example we will change the UI to the DarkSteelUI
	 * 
	 * @param accordion
	 */
	 ...
	 * Background Painter, AccordionTabRenderers or tweak values on the currently
	 * installed Background Painter, AccordionTabRenderers and UI.
	 * 
	 * @param accordion
	 */
	private void howToCustomizeALookAndFeel(JSCAccordion accordion) {
		...
		// but it just serves to illustrate how to customize the accordion's look and
		// feel.
		// The UI is darkSteel.
